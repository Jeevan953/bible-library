...
EXPECTED_HEADERS = [
    (1, "JPS / WEY"),
    (2, "JPS Tanakh 1917 OT / Weymouth NT"),
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if len(source_rows) != 31062:
            errors.append(
                "Expected 31062 verse texts, found "
                f"{len(source_rows)}"
            )
            ...
            version, created = (
                BibleVersion.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "year": 1917,
                        "description": (
                            "The 1917 Jewish Publication "
                            "Society Tanakh for the Old "
                            "Testament, combined with the "
                            "Weymouth New Testament."
                        ),
                        "pdf_filename": "jps.pdf",
                    },
                )
            )
