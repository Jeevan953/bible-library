...
# These verse markers contain only textual footnotes.
EXPECTED_EMPTY = {
    ("MAT", 17, 21),
    ("MAT", 18, 11),
    ("MAT", 23, 14),
...
class Command(BaseCommand):
    help = "Import the Free Bible Version from USFM files."
    ...
    def handle(self, *args, **options):
        ...
        pdf_path = folder.parent / "fbv.pdf"
        ...
        with transaction.atomic():
            ...
            version.name = "Free Bible Version"
            version.language = "English"
            version.year = 2018
            version.description = (
                "Free Bible Version, translated by "
                "Dr. Jonathan Gallagher. Copyright © 2018 "
                "Dr. Jonathan Gallagher; source: eBible.org; "
                "licensed under CC BY-SA 4.0."
            )
            version.pdf_filename = "fbv.pdf"
            version.save()
