...
DESCRIPTION = (
    "African International New Testament: "
    "Explanatory Paraphrase (American English "
    ...
    "application: the second 1 John 3:6 marker "
    "was assigned to 1 John 3:7; 3 John 1:15 "
    "was combined with canonical 3 John 1:14; "
    "Revelation 12:18 was combined with canonical "
    "Revelation 13:1; and a duplicate John 5:3 "
    "explanatory note about John 5:4 was excluded."
)
...
class Command(BaseCommand):
    help = (
        ...
        "Testament Explanatory Paraphrase from "
        "its DBL USX bundle."
    )
    ...
    def handle(self, *args, **options):
        ...
        if len(source_texts) != 7937:
            raise CommandError(
                "Expected 7,937 normalized verse "
    ...
    def validate_metadata(
        ...
        expected_identification = {
            "name": (
                ...
                "Testament: Explanatory Paraphrase "
    ...
    def normalize_versification(
        ...
        for key, values in occurrences.items():
            ...
            if key == (62, 3, 6):
                if len(values) != 2:
                    raise CommandError(
                        "Expected exactly two "
                        "1 John 3:6 occurrences."
                    )

                texts[(62, 3, 6)] = values[0]
                texts[(62, 3, 7)] = values[1]
                adjustments.append(
                    "remapped second 1 John 3:6 "
                    "to 1 John 3:7"
                )
                continue
        ...
        if not revelation_12_18:
            raise CommandError(
                "Revelation 12:18 was not found."
            )

        texts[(66, 13, 1)] = normalize_text(
            [
                revelation_12_18,
                " ",
                texts[(66, 13, 1)],
