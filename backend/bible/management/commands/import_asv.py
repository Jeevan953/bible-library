...
FILE_PATTERN = re.compile(
    r"^\d+-(?P<code>[A-Z0-9]+)eng-asv\.usfm$",
    re.IGNORECASE,
)
...
class Command(BaseCommand):
    help = "Import the American Standard Version from USFM files."
    ...
    def handle(self, *args, **options):
        ...
        pdf_path = folder.parent / "asv.pdf"
        ...
        with transaction.atomic():
            ...
            version.name = "American Standard Version"
            version.language = "English"
            version.year = 1901
            version.description = (
                "Canonical 66-book American Standard Version "
                "imported from the ASV USFM source."
            )
            version.pdf_filename = "asv.pdf"
            version.save()
