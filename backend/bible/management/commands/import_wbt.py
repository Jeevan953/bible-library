...
class Command(BaseCommand):
    help = "Import Webster's Bible Translation."
    ...
    def handle(self, *args, **options):
        ...
        if empty_keys:
            errors.append(
                f"Unexpected empty positions: {sorted(empty_keys)}"
            )
            ...
            version, created = (
                BibleVersion.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "year": 1833,
                        "description": (
                            "Webster's revision of the "
                            "King James Bible."
                        ),
                        "pdf_filename": "wbt.pdf",
                    },
                )
            )
